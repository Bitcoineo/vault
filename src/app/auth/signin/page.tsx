    ...
    <div className="w-full max-w-sm animate-fade-in-up">
      <div className="rounded-2xl border border-border bg-bg-primary p-8 shadow-lg">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-full border border-border bg-bg-primary px-4 py-2.5 text-sm font-medium text-fg-primary shadow-sm transition-all hover:shadow-md"
        >
...
export default function SignInPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-blue-50/50 to-bg-primary px-4 animate-page-fade-in">
      <Suspense>
        <SignInForm />
      </Suspense>
    </div>
